...
void main() {
  ...
  gl_FragColor = color;
      ...
      const loop = t => {
        ...
        if (!reducedMotion.matches) uniforms.iTime.value = t * 0.001;
        try {
          renderer.render({ scene: mesh });
          if (!reducedMotion.matches) animationIdRef.current = requestAnimationFrame(loop);
        } catch (e) {
          return;
        }
      };
      ...
      const resizeObserver = new ResizeObserver(() => { updateSize(); resume(); });
